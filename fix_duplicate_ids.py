...
# Locate where appended CTRM blocks start and slice clean base code
markers = [
    "# >>> UNIQUE_CTRM_RISK_ENGINE_DESK",
    "# =====================================================================",
    "🌋 Risk Scenario Injector"
]
...
clean_base = content[:cutoff].strip()

# Append ONE clean CTRM extension with unique keys on every single widget
ctrm_extension = """
...
print("✅ Deduplicated script and explicitly mapped all widget IDs!")
